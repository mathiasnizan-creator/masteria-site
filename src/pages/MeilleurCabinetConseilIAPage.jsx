...
export default function MeilleurCabinetConseilIAPage() {
  ...
  return (
    <>
      ...
      <CaseStudyCards
        ids={['photovoltaique', 'industrie', 'conseil-financier']}
        title="Ce que livre un cabinet qui tient les trois compétences"
        intro="Trois missions anonymisées où conseil, construction et formation s'enchaînent : diagnostic et chantiers pour une PME, comité de direction et déploiement international pour un groupe, assistants d'appels d'offres pour un cabinet."
      />
