      ...
      <section style={{ background: '#F9FAFB', padding: 'clamp(56px, 10vw, 96px) clamp(18px, 4vw, 32px)', borderTop: '1px solid #E5E7EB' }}>
        <div style={{ maxWidth: 1080, margin: '0 auto' }}>
          ...
          <p style={{ maxWidth: 760, margin: '0 auto 44px', textAlign: 'center', fontSize: 17, color: '#374151', lineHeight: 1.7 }}>
            <strong style={{ color: '#0A0A0A' }}>Au-delà de la formation, Masteria est un cabinet de conseil et une agence de développement IA : nous cadrons votre <Link to="/conseil-strategie-ia" style={{ color: '#2563EB', textDecoration: 'none' }}>stratégie IA</Link>, puis nous concevons et développons les agents, automatisations et outils sur mesure qui s'intègrent à votre environnement.</strong> Du diagnostic au déploiement, avec transfert aux équipes. Nous pouvons aussi détacher des développeurs IA chez vous, sur site ou à distance. Pour aller plus loin, explorez les leviers de l'<Link to="/ia-generative-entreprise" style={{ color: '#2563EB', fontWeight: 700, textDecoration: 'none' }}>IA générative en entreprise</Link> et nos <Link to="/cas-usage-ia-entreprise" style={{ color: '#2563EB', fontWeight: 700, textDecoration: 'none' }}>cas d'usage de l'IA en entreprise</Link>. Découvrez aussi notre <Link to="/agence-automatisation-ia" style={{ color: '#2563EB', fontWeight: 700, textDecoration: 'none' }}>agence d'automatisation IA</Link>, nos <Link to="/agents-ia-entreprise" style={{ color: '#2563EB', fontWeight: 700, textDecoration: 'none' }}>agents IA en entreprise</Link> et notre <Link to="/agence-seo-ia" style={{ color: '#2563EB', fontWeight: 700, textDecoration: 'none' }}>agence SEO IA</Link>. Pour juger sur pièces, lisez nos <Link to="/etudes-de-cas-ia" style={{ color: '#2563EB', fontWeight: 700, textDecoration: 'none' }}>études de cas IA</Link> : trois déploiements en entreprise, résultats mesurés.
          </p>
