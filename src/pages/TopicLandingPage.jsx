...
const TOPICS = {
  'formation-intelligence-artificielle-cpf': {
    ...
    faq: [
      ...
      { q: "Combien coûte une formation IA Masteria ?", a: "1 980 € HT par jour, en intra-entreprise (jusqu'à 12 participants) comme en accompagnement individuel sur mesure (coaching 1-to-1). Une journée pour le programme initiation, deux jours pour la version approfondie multi-outils." },
