...
const CASES = [
  {
    ...
    resultat: "Toutes les équipes sont formées et les premiers assistants sont en production. 58 personnes assistées par Claude visent la force de frappe d'une équipe de 70, sans recrutement.",
  },
  {
    id: 'industrie',
    icon: Factory,
    kicker: 'Cas 02 · Industrie',
    who: 'Groupe industriel international du packaging, plusieurs milliers de salariés',
    title: 'Un parcours Copilot pour les managers, construit sur leurs vrais fichiers',
    stats: [
      ['89,8 %', 'de satisfaction (session pilote)'],
      ['11 / 11', 'recommandent la formation'],
      ['4,9 / 5', "utilité concrète pour le poste"],
      ['~30', 'collaborateurs au premier palier (COMEX + pilotes)'],
    ],
    defi: "Les équipes IT du groupe ont retenu Microsoft 365 Copilot et le déploiement à l'échelle approche. L'enjeu : préparer l'adoption sur deux niveaux, décider et cadrer côté comité de direction, mettre en pratique côté managers pilotes, avec un critère strict pour ces derniers : repartir avec des usages applicables à leur poste dès le retour au bureau, pas une démonstration de fonctionnalités.",
    ...
    resultat: "Session pilote mesurée à chaud : 89,8 % de satisfaction moyenne, 11 participants sur 11 qui recommandent la formation, et 4,9/5 sur l'utilité concrète au poste. Les ateliers sur fichiers réels sont reconduits pour les vagues suivantes.",
        ...
        <div style={{ maxWidth: 900, margin: '0 auto', position: 'relative' }}>
          ...
          <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid #1E293B', borderRadius: 14, padding: 'clamp(20px, 3vw, 28px)', maxWidth: 760 }}>
            ...
            <dl style={{ margin: 0, display: 'grid', gap: 14 }}>
              {[
                ['Distribution B2B (58 pers.)', "10 référents formés puis toutes les équipes, 11 assistants Claude métier, les premiers déjà en production."],
                ['Industrie (groupe international)', "Parcours managers Copilot sur fichiers réels : 89,8 % de satisfaction en session pilote, 11 participants sur 11 recommandent."],
