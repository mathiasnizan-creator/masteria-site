  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: { '@type': 'Answer', text: "Notre formation panorama de 2 jours permet de tester les 5 outils sur les cas d'usage réels de vos équipes avant de décider. 760 €/jour/participant en inter-entreprises, finançable OPCO. Idéale avant un déploiement à l'échelle." },
      },
    ],
  }
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Notre formation panorama de 2 jours permet de tester les 5 outils sur les cas d'usage réels de vos équipes avant de décider. 760 €/jour/participant en inter-entreprises, finançable OPCO. Idéale avant un déploiement à l'échelle.",
  },
  {
