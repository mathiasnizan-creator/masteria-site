...
const FAQ = [
  ...
  { q: "Cette formation couvre-t-elle la conduite d'un projet d'IA en entreprise ?", a: "Le cœur du programme apprend à utiliser l'IA générative dans le pilotage de projets classiques. Pour les équipes qui doivent aussi piloter un projet de déploiement d'IA, nous ajoutons un volet dédié : cadrage et priorisation des cas d'usage, calcul du ROI, obligations AI Act, MLOps light, conduite du changement et mesure d'impact. Ce volet se traite en journée complémentaire ou en session intra sur mesure, à partir de vos projets réels. Conçu pour des chefs de projet et des PMO, pas pour des data scientists." },
