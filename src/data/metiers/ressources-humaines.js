...
export default {
 ...
 "enBref": [
  ...
  {
   "label": "Pour qui",
   "value": "DRH et RRH, chargés de recrutement, gestionnaires RH et paie, responsables formation et développement des compétences, communication interne"
  },
  {
   "label": "Outils",
 ...
 "missions": [
  ...
  },
  {
   ...
   "desc": "Parcours d'intégration structuré, livret d'accueil, mails de bienvenue par étape, check-lists manager, FAQ nouveaux arrivants : ce qui manque souvent faute de temps se produit en une séance, à votre ton, et se personnalise par poste."
  },
  {
   "icon": "MessagesSquare",
   "title": "Entretiens et évaluations",
   "desc": "Préparer un entretien annuel ou professionnel à partir des objectifs et des éléments de l'année, structurer un compte rendu, formuler des objectifs SMART, préparer un feedback difficile. L'IA aide le manager et le RH à écrire juste ; l'évaluation elle-même reste un jugement humain, jamais un score généré."
  },
  {
   "icon": "Megaphone",
   "title": "Communication interne",
   "desc": "Notes de service, annonces, newsletters internes, réponses aux questions fréquentes, communication d'un changement d'organisation : des écrits clairs et homogènes, adaptés par population, produits en un temps réduit."
  },
  {
   "icon": "GraduationCap",
 ...
 "atouts": [
  {
   "title": "Des recrutements mieux préparés",
   "desc": "Offres claires et non discriminantes, messages d'approche personnalisés, grilles d'entretien par compétence : la préparation gagne en qualité et en cohérence, et le temps se déplace vers l'échange avec les candidats."
  },
  {
   "title": "Un onboarding enfin complet",
   "desc": "Parcours, livret, mails par étape, check-lists : ce que le manque de temps laissait inachevé se produit et se personnalise par poste, pour une intégration qui tient."
  },
  {
   "title": "Des entretiens et feedbacks mieux écrits",
 ...
 "programme": [
  {
   ...
   "apresmidi": [
    ...
    {
     "t": "Atelier onboarding sur un poste réel",
     "d": "Parcours d'intégration semaine par semaine, livret d'accueil, mails de bienvenue par étape, check-list du manager et FAQ des nouveaux arrivants, générés à votre ton depuis votre trame existante puis personnalisés pour un poste qui recrute en ce moment."
    },
    {
     "t": "Atelier entretiens annuels et professionnels",
  ...
  {
   "jour": "Jour 2",
   "titre": "Communication interne, compétences, données RH, agents et gouvernance",
   "matin": [
    {
    ...
    },
    {
     ...
     "d": "Le courrier disciplinaire ou de rupture, où Copilot dans Word ou Claude n'interviennent que sur la forme, jamais sur le fond ni la décision ; puis la cartographie des compétences d'un service, structurée à partir des fiches de poste, la stratégie restant la vôtre."
    }
   ],
   "apresmidi": [
    {
 ...
 "profils": [
  ...
  {
   "icon": "GraduationCap",
   "title": "Responsables formation et communication interne",
   "desc": "Plan de compétences, fiches, notes, newsletters, communication du changement : les usages qui structurent la montée en compétence et le message interne."
  }
 ],
 "cadre": {
 ...
 "course": {
  ...
  "teaches": [
   ...
   "Construire des parcours d'onboarding et une communication interne homogène",
   "Préparer entretiens, feedbacks et objectifs sans déléguer l'évaluation",
   "Outiller le plan de développement des compétences et répondre à l'article 4",
   "Appliquer le cadre RGPD et non-discrimination aux usages RH de l'IA"
  ],
  "about": "Intelligence artificielle générative appliquée aux ressources humaines",
  "timeRequired": "PT14H",
  "duration": "PT14H",
  ...
  "about": [
   {
    ...
    "sameAs": "https://fr.wikipedia.org/wiki/Gestion_des_ressources_humaines"
   },
   {
    "@type": "Thing",
    "name": "Recrutement",
    "sameAs": "https://fr.wikipedia.org/wiki/Recrutement"
   },
   {
    "@type": "Thing",
