...
export const GEO_CITIES = [
  ...
  },
  {
    ...
    additionalFAQ: [
      ...
      { q: 'Où se déroulent les formations IA à Bruxelles ?', a: "Dans vos locaux, dans les dix-neuf communes de Bruxelles-Capitale (du quartier européen de Schuman au centre) et dans le Brabant wallon : Louvain-la-Neuve, Wavre, Nivelles. Former l'équipe sur son poste de travail, avec ses vrais outils et ses vrais documents, est le format le plus efficace. Le distanciel reste disponible pour les équipes réparties entre plusieurs implantations." },
    ],
  },
]
