...
export const HUBS = [
  {
    ...
    metaTitle: 'Formation ChatGPT entreprise 2 jours · Qualiopi · OPCO | Masteria',
  ...
  },
  {
    ...
    metaTitle: 'Formation Microsoft 365 Copilot 2 jours · Word Excel Teams · Qualiopi | Masteria',
  ...
  },
  {
    ...
    metaTitle: 'Formation Google Gemini 2 jours · Workspace + NotebookLM · Qualiopi | Masteria',
  ...
  },
  {
    ...
    metaTitle: "Formation Claude IA Anthropic 2 jours · Code, 200k tokens · Qualiopi | Masteria",
  ...
  },
  {
    ...
    metaTitle: "Formation Mistral AI 🇫🇷 IA souveraine 2 jours · RGPD · Qualiopi | Masteria",
...
const BASE_SPOKES = [
  ...
  // ── Multi-outils × Assistante de direction ──────────────────────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "760 €/jour/participant en inter-entreprises, 1 500 €/jour pour un groupe en intra (jusqu'à 12). 100 % finançable OPCO." },
    ],
  ...
  // ── Multi-outils × Achats ───────────────────────────────────────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "760 €/participant en inter, 1 500 €/jour pour un groupe en intra (jusqu'à 12). 100 % finançable OPCO." },
    ],
  ...
  // ── Multi-outils × Service Client (relation client / SAV) ───────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "1 520 €/participant en inter (2 jours), 3 000 €/jour pour un groupe en intra. 100 % finançable OPCO." },
    ],
  ...
  // ── Multi-outils × Management (Manager avec l'IA) ───────────────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "1 520 €/manager en inter (2 jours), 3 000 €/jour en intra (jusqu'à 12 managers). 100 % finançable OPCO." },
    ],
  ...
  // ── Multi-outils × Veille (transversal / Marketing) ─────────────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "760 €/participant en inter, 1 500 €/jour en intra. 100 % finançable OPCO." },
    ],
  ...
  // ── Multi-outils × Analyse de données (Finance) ─────────────────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "1 520 €/participant en inter (2 jours), 3 000 €/jour en intra (jusqu'à 12). 100 % finançable OPCO." },
    ],
  ...
  // ── Multi-outils × Piloter un projet IA (Informatique / DSI) ────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "1 520 €/participant en inter (2 jours espacés), 3 000 €/jour en intra. 100 % finançable OPCO." },
    ],
  ...
  // ── Multi-outils × Plan compétences DRH (RH) ────────────────────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "1 520 €/participant en inter (2 jours), 3 000 €/jour en intra (jusqu'à 12 DRH/RRH). 100 % finançable OPCO." },
    ],
  ...
  // ── Sprint IA × Sensibilisation ─────────────────────────────────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "760 €/participant en inter (3 h). Intra : 1 500 €/session (jusqu'à 12 participants). Packages dégressifs à partir de 5 sessions pour les déploiements grande échelle. 100 % finançable OPCO." },
    ],
  ...
  // ── Sprint IA × Prompts ─────────────────────────────────────────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "760 €/participant en inter, 1 500 €/session en intra (jusqu'à 12). Packages dégressifs à partir de 5 sessions. 100 % finançable OPCO." },
    ],
  ...
  // ── Sprint IA × Managers ────────────────────────────────────────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "760 €/participant en inter, 1 500 €/session en intra (jusqu'à 12). Packages dégressifs à partir de 5 sessions pour les déploiements managériaux. 100 % finançable OPCO." },
    ],
  ...
  // ── Sprint IA × AI Act ──────────────────────────────────────────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "760 €/participant en inter, 1 500 €/session en intra (jusqu'à 12). Packages dégressifs à partir de 5 sessions, particulièrement pertinent pour cascader la conformité dans une grande organisation. 100 % finançable OPCO." },
    ],
