...
export const HUBS = [
  ...
  },
  {
    ...
    metaTitle: "Catalogue 89 formations IA · Par outil et métier | Masteria",
    metaDesc: "Catalogue de 89 formations IA certifiées Qualiopi, finançables OPCO. ChatGPT, Copilot, Gemini, Claude, Mistral. Devis sous 24 h.",
    h1: "Formation IA pour les entreprises",
...
const BASE_SPOKES = [
  ...
  // ── Multi-outils × Assistante de direction ──────────────────────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "1 980 €/jour pour un groupe en intra-entreprise (jusqu'à 12 participants) ou 1 380 €/jour en accompagnement individuel sur mesure. 100 % finançable OPCO." },
    ],
  ...
  // ── Multi-outils × Achats ───────────────────────────────────────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "1 980 €/jour pour un groupe en intra-entreprise (jusqu'à 12 participants) ou 1 380 €/jour en accompagnement individuel. 100 % finançable OPCO." },
    ],
  ...
  // ── Multi-outils × Service Client (relation client / SAV) ───────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "3 960 €/groupe intra-entreprise pour 2 jours (jusqu'à 12 participants, soit 1 980 €/jour) ou 2 760 € en accompagnement individuel pour 2 jours (1 380 €/jour). 100 % finançable OPCO." },
    ],
  ...
  // ── Multi-outils × Management (Manager avec l'IA) ───────────────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "3 960 €/groupe intra-entreprise pour 2 jours (jusqu'à 12 managers, soit 1 980 €/jour) ou 2 760 € en accompagnement individuel pour 2 jours (1 380 €/jour). 100 % finançable OPCO." },
    ],
  ...
  // ── Multi-outils × Veille (transversal / Marketing) ─────────────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "1 980 €/jour en intra-entreprise (jusqu'à 12 participants) ou 1 380 €/jour en accompagnement individuel. 100 % finançable OPCO." },
    ],
  ...
  // ── Multi-outils × Piloter un projet IA (Informatique / DSI) ────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "3 960 €/groupe intra-entreprise pour 2 jours espacés (jusqu'à 12 participants, soit 1 980 €/jour) ou 2 760 € en accompagnement individuel pour 2 jours (1 380 €/jour). 100 % finançable OPCO." },
    ],
  ...
  // ── Multi-outils × Plan compétences DRH (RH) ────────────────────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "3 960 €/groupe intra-entreprise pour 2 jours (jusqu'à 12 DRH/RRH, soit 1 980 €/jour) ou 2 760 € en accompagnement individuel pour 2 jours (1 380 €/jour). 100 % finançable OPCO." },
    ],
  ...
  // ── Sprint IA × Sensibilisation ─────────────────────────────────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "1 980 €/session en intra-entreprise (jusqu'à 12 participants, 3 h) ou 1 380 €/session en accompagnement individuel. Packages dégressifs à partir de 5 sessions pour les déploiements grande échelle. 100 % finançable OPCO." },
    ],
  ...
  // ── Sprint IA × Prompts ─────────────────────────────────────────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "1 980 €/session en intra-entreprise (jusqu'à 12 participants) ou 1 380 €/session en accompagnement individuel. Packages dégressifs à partir de 5 sessions. 100 % finançable OPCO." },
    ],
  ...
  // ── Sprint IA × Managers ────────────────────────────────────────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "1 980 €/session en intra-entreprise (jusqu'à 12 participants) ou 1 380 €/session en accompagnement individuel. Packages dégressifs à partir de 5 sessions pour les déploiements managériaux. 100 % finançable OPCO." },
    ],
  ...
  // ── Sprint IA × AI Act ──────────────────────────────────────────────────
  {
    ...
    faq: [
      ...
      { q: "Combien ça coûte ?", a: "1 980 €/session en intra-entreprise (jusqu'à 12 participants) ou 1 380 €/session en accompagnement individuel. Packages dégressifs à partir de 5 sessions, particulièrement pertinent pour cascader la conformité dans une grande organisation. 100 % finançable OPCO." },
    ],
    relatedSpokes: ['formation-sprint-ia-sensibilisation', 'formation-sprint-ia-managers', 'formation-ia-rh'],
  },
