...
const BASE_SPOKES = [
  ...
  // ── Prompt Engineering × Tous métiers ────────────────────────────────────
  {
    ...
    metaDesc: "Formation prompt engineering (formation prompt IA) : méthode, techniques avancées, bibliothèque de prompts d'équipe. 1 jour pratique, tous outils. Qualiopi, OPCO.",
    h1: 'Formation prompt engineering : des prompts IA professionnels, des résultats fiables',
    intro: "Le prompt engineering, la conception de prompts IA efficaces, est la compétence qui détermine 80 % de la qualité de ce que vos équipes obtiennent de ChatGPT, Claude, Copilot, Gemini ou Mistral. Cette formation d'1 jour leur donne une méthode complète : structurer un prompt professionnel, fiabiliser les réponses, construire la bibliothèque de prompts de l'équipe. Ateliers sur vos cas réels, quel que soit l'outil déjà déployé chez vous.",
    audience: [
  ...
  // ── IA × Dirigeants ──────────────────────────────────────────────────────
  {
    ...
    toolColor: '#2563EB',
    toolColorLight: '#dbeafe',
    metier: 'Dirigeants & CODIR',
    metierSlug: 'management',
    priority: true,
    duration: '1j',
    metaTitle: 'Formation IA dirigeants : décider et piloter | Masteria',
    metaDesc: "Formation IA pour dirigeants et CODIR : enjeux stratégiques, ROI, gouvernance, AI Act, feuille de route 90 jours. Format confidentiel. Qualiopi, OPCO.",
  ...
  // ── AI Act × Conformité ──────────────────────────────────────────────────
  {
    ...
    priority: true,
    duration: '1j',
    keywords: "formation ai act, formation ia act, ia act, ai act entreprise, mise en conformité ai act, article 4 ai act, littératie ia, cartographie des risques ia, formation conformité ia, certifié qualiopi, finançable opco",
  ...
  // ── Gouvernance IA × Pilotage ────────────────────────────────────────────
  {
    ...
    keywords: "formation gouvernance ia, formation gouvernance de l'ia, gouvernance ia, registre des usages ia, charte ia, comité ia, gouvernance des données pour l'ia, formation conformité ia, formation ia act, certifié qualiopi, finançable opco",
