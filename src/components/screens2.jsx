  ...
  return (
    <section style={{ padding: 'clamp(48px, 8vw, 72px) clamp(18px, 4vw, 32px)', background: bg }}>
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        <FadeIn>
          <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#6B7280', marginBottom: 10 }}>FAQ</div>
          ...
          {items.map((item, i) => (
            <div key={i} style={{ borderBottom: '1px solid #E2E2E2' }}>
              <button onClick={() => setOpen(open === i ? null : i)}
                ...
                <span style={{ fontSize: 20, color: open === i ? '#1C1C1C' : '#6B7280', flexShrink: 0, transform: open === i ? 'rotate(45deg)' : 'none', transition: 'transform 220ms ease', lineHeight: 1, fontWeight: 300 }}>+</span>
              </button>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 'clamp(20px, 4vw, 32px)', alignItems: 'start' }}>
          ...
          <div style={{ background: '#F8F8F8', borderRadius: 14, padding: '28px' }}>
            <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#6B7280', marginBottom: 10 }}>Tarif indicatif</div>
            ...
            <div style={{ marginTop: 10, fontSize: 11, color: '#6B7280', textAlign: 'center' }}>Réponse sous 24h · Sans engagement</div>
          </div>
        </div>
      </div>
    </section>
  ...
  return (
    <div style={{ background: '#fff', borderRadius: 14, border: '1.5px solid #E8E8E8', padding: '22px 24px' }}>
      ...
      <div style={{ marginBottom: 10 }}>
        ...
        {cur.unit && <span style={{ fontSize: 11, color: '#6B7280', marginLeft: 4 }}>{cur.unit}</span>}
      </div>
      {cur.details.map((d, i) => (
