...
const ONGLETS = [
  { cle: 'une', label: 'La une', to: '/veille-ia', icon: Newspaper },
  { cle: 'publications', label: 'Toutes les publications', to: '/veille-ia/publications', icon: Library },
  { cle: 'apropos', label: 'À propos', to: '/veille-ia/a-propos', icon: Info },
]

export default function VeilleNav({ active = null }) {
  return (
    <nav
      aria-label="Navigation de la Veille IA"
    ...
    >
      <div style={{
        ...
        <a
          href="/veille.xml"
          className="veille-onglet"
          aria-label="Flux RSS de la Veille IA"
          style={{
